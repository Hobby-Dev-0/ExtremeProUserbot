...
@client.on(admin_cmd(pattern="eye$"))
@client.on(sudo_cmd(pattern="eye$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@client.on(admin_cmd(pattern="thinking$"))
@client.on(sudo_cmd(pattern="thinking$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@client.on(admin_cmd(pattern=f"snake$", outgoing=True))
@client.on(sudo_cmd(pattern="snake$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@client.on(admin_cmd(pattern=f"human$", outgoing=True))
@client.on(sudo_cmd(pattern="human$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@client.on(admin_cmd(pattern=f"mc$", outgoing=True))
@client.on(sudo_cmd(pattern="mc$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@client.on(admin_cmd(pattern="virus$"))
@client.on(sudo_cmd(pattern="virus$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@client.on(admin_cmd(pattern=r"repe$", outgoing=True))
@client.on(sudo_cmd(pattern="repe$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@client.on(admin_cmd(pattern=f"nikal$", outgoing=True))
@client.on(sudo_cmd(pattern="nikal$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.5
...
@client.on(admin_cmd(pattern=f"squ$", outgoing=True))
@client.on(sudo_cmd(pattern="squ$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
