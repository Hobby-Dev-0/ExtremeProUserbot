...
@client.on(extremepro_cmd(pattern="create (b|g|c) (.*)"))  # pylint:disable=E0602
@client.on(amanpandey_cmd(pattern="create (b|g|c) (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
