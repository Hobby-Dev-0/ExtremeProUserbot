...
@Andencento.on(admin_cmd(pattern=r"macos"))
async def _(event):
...
@Andencento.on(admin_cmd(pattern=r"windows"))
async def _(event):
...
@Andencento.on(admin_cmd(pattern=r"linux"))
async def _(event):
...
@Andencento.on(admin_cmd(pattern=r"stock"))
async def _(event):
...
@Andencento.on(admin_cmd(pattern=r"os"))
async def _(event):
