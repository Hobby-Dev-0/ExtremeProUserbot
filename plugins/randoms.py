...
@client.on(admin_cmd(pattern=r"sing$", outgoing=True))
@client.on(sudo_cmd(pattern=r"sing$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@client.on(admin_cmd(pattern=f"hps$", outgoing=True))
@client.on(sudo_cmd(pattern=f"hps$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@client.on(admin_cmd(pattern=f"gott$", outgoing=True))
@client.on(sudo_cmd(pattern=f"gott$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@client.on(admin_cmd(pattern=f"gotm$", outgoing=True))
@client.on(sudo_cmd(pattern=f"gotm$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@client.on(admin_cmd(pattern="bello$", outgoing=True))
@client.on(sudo_cmd(pattern="bello$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    event = await edit_or_reply(event, "Typing....")
...
@client.on(admin_cmd(pattern=r"tip$", outgoing=True))
@client.on(sudo_cmd(pattern=r"tip$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@client.on(admin_cmd(pattern=r"qt$"))
@client.on(sudo_cmd(pattern=r"qt$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@client.on(admin_cmd(pattern=f"logic$", outgoing=True))
@client.on(sudo_cmd(pattern=f"logic$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
